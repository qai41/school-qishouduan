<template name="graceDate">
	<view class="grace-date" v-if="show">
		...
		<view class="grace-date-close" @tap="close">取消选择</view>
	</view>
</template>
<script>
...
.grace-date-time .timer picker view{line-height:80upx;}
...
.grace-date-close{text-align:center; color:#999999; margin-top:22px;}
</style>
